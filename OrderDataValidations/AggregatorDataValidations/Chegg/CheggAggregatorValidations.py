...
class CheggAggregatorValidations:
    def aggregator_data_validations(self,test_data):
        ...
        logger.info("\n\t------Starting Chegg Aggregator Data Validations------")
        print("\n------Starting Chegg Aggregator Data Validations------")
        load_data = test_data
        ...
        # Initialising the file with Chegg validation Rules Json
        with open(BASE_PATH1 + '/Chegg-validation-rules.json') as f:
        ...
        # Running validation on entire frame based on Chegg Validation Rules Json
